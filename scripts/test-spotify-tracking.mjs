...
let panel=null;
const map={'#results':results,'.results-wrap':wrap,'.profile':profile,'#search':el('search'),'#searchForm':el('searchForm')};
...
const context={console,document,window:{},fetch:async url=>{
